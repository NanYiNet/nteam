...
<title>管理员列表 - <?php echo conf('Name');?> - 后台管理中心</title>
    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-toolbar clearfix">
          <form class="pull-right search-bar" method="get" onsubmit="return searchAdmin()" role="form">
            <div>
              <div class="form-group" style="display: inline-block;float: left;">
              <select name="column" class="form-control"><option value="1">搜索</option><option value="adminUser">账号</option><option value="adminQq">QQ</option></select>
              </div>
          ...
          <div class="toolbar-btn-action">
            <a class="btn btn-primary m-r-5" href="./aset.php?my=add"><i class="mdi mdi-plus"></i> 新增</a>
          </div>
        </div>
